// Bloom stage 2/4 — separable gaussian blur, HORIZONTAL pass.
//
// Pairs with bloom_blur_v.wgsl — identical 9-tap gaussian, the
// two files differ ONLY in the AXIS vector. Two files (not one
// parameterized shader) because the WgpuDispatcher pipeline
// cache keys by Material name and both passes share one
// BloomParams uniform; baking the axis keeps the uniform
// frame-invariant across both passes.
